local DawnHub = Instance.new("ScreenGui")
...
DawnHub.Name = "DawnHub"
DawnHub.Parent = game.CoreGui
DawnHub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
Setting:Seperator("「 Credits 」")
    ...
    Setting:Label("Ui Remade By Dawn.") 
...
Update:Notification("Hello, "  ..game.Players.LocalPlayer.DisplayName.. " Welcome DawnHub V2! What's new? | [+] New Ui [+] New Functions [+] Fix Some Bugs [+] Optimise Script [+] Much More... ")
